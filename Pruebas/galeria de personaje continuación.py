...
for i in range(15):
    ...
    lbl = tk.Label(ventana, text=nombres_de_personajes[i], font= "Arial, 18") #real lo marcado
    ...
    btn = tk.Checkbutton(ventana, variable=var, command=lambda v=var: contadorseleccion(v), font="Arial, 14")  #lambda hace que
...
botoncontinue = tk.Button(ventana, text="Confirmar", font= "Arial, 18")
